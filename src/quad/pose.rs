...
impl QuadPose{
    ...
    pub fn with_angular_acceleration(mut self, angular_acceleration: nalgebra::Vector3<f64>) -> QuadPose{
...
mod tests {
    ...
    fn test_quad_pose(){
        ...
        assert_eq!(pose.orientation, nalgebra::UnitQuaternion::from_euler_angles(0.0, 0.0, 0.0));
        ...
        assert_eq!(pose.angular_acceleration, nalgebra::Vector3::new(13.0, 14.0, 15.0));
    }
}
